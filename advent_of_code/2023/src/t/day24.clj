...
(defn part2
  ...
  (let [[[[a1 a2 a3] [da1 da2 da3]]
    ...
    (ex/solve '[x1 x2 x3 dx1 dx2 dx3 t1 t2 t3]
                (ex/ex (= (+ x1 (* t1 dx1)) (+ a1 (* t1 da1))))
                (ex/ex (= (+ x2 (* t1 dx2)) (+ a2 (* t1 da2))))
                (ex/ex (= (+ x3 (* t1 dx3)) (+ a3 (* t1 da3))))
                (ex/ex (= (+ x1 (* t2 dx1)) (+ b1 (* t2 db1))))
                (ex/ex (= (+ x2 (* t2 dx2)) (+ b2 (* t2 db2))))
                (ex/ex (= (+ x3 (* t2 dx3)) (+ b3 (* t2 db3))))
                (ex/ex (= (+ x1 (* t3 dx1)) (+ c1 (* t3 dc1))))
                (ex/ex (= (+ x2 (* t3 dx2)) (+ c2 (* t3 dc2))))
                (ex/ex (= (+ x3 (* t3 dx3)) (+ c3 (* t3 dc3)))))
